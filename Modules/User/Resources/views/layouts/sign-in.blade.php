...
<head>
    ...
    <!-- CSS Files -->
    <link href="{{url('assets/css/soft-ui-dashboard.css')}}" rel="stylesheet" type="text/css"/>
            ...
            <nav
                ...
                <div class="container-fluid">
                    <a class="navbar-brand font-weight-bolder ms-lg-0 ms-3 " href="#">
                        Newsifier Project Task: Sign in
                    </a>
                    ...
                    <div class="collapse navbar-collapse" id="navigation">
                        <ul class="navbar-nav mx-auto">
                            <li class="nav-item">
                                <a class="nav-link me-2" href="{{route('user.show.sign-up')}}">
                    ...
                    <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
                        <div class="card card-plain mt-8">
                            <div class="card-header pb-0 text-left bg-transparent">
                                <h3 class="font-weight-bolder text-info text-gradient">Welcome To Newsifier Project
                                    Task... </h3>
                            ...
                            <div class="card-body">
                                ...
                                @if($errors->has('phone'))
                                    ...
                                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                        <span
                                            class="alert-text"><strong>Error!</strong> {{ $errors->first('phone') }}</span>
                                        <button type="button" class="btn-close" data-bs-dismiss="alert"
                                                aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                ...
                                <form method="POST" action="{{route('user.signing-in')}}" role="form">
                                    @csrf
                                    <div class="mb-3">
                            ...
                            <div class="card-footer text-center pt-0 px-lg-2 px-1">
                                <p class="mb-4 text-sm mx-auto">
                                    ...
                                    <a href="{{route('user.show.sign-up')}}"
