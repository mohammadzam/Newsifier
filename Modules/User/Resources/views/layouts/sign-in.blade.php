            ...
            <nav class="navbar navbar-expand-lg blur blur-rounded top-0 z-index-3 shadow position-absolute my-3 py-2 start-0 end-0 mx-4">
                <div class="container-fluid">
                    <a class="navbar-brand font-weight-bolder ms-lg-0 ms-3 " href="#">
                        Motarjem 4 You:  Sign in to admin dashboard
                    </a>
                ...
                <span class="navbar-toggler-bar bar3"></span>
                    ...
                    <div class="collapse navbar-collapse" id="navigation">
                        <ul class="navbar-nav mx-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link me-2" href="{{route('show.sign-up.page')}}">
                        ...
                        <ul class="navbar-nav d-lg-block d-none">
                            <li class="nav-item">
                                <a href="https://www.creative-tim.com/product/soft-ui-dashboard" class="btn btn-sm btn-round mb-0 me-1 bg-gradient-dark">Back To Home Page</a>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
                        <div class="card card-plain mt-8">
                            <div class="card-header pb-0 text-left bg-transparent">
                                <h3 class="font-weight-bolder text-info text-gradient">Welcome To Motarjem 4 You... </h3>
                                <p class="mb-0">Enter your email or teacher number and password to sign in</p>
                            </div>
                            <div class="card-body">
                                ...
                                @endif
                                <label>Email Or Teacher Number</label>

                                <form method="POST" action="{{route('admin.signing-in')}}" role="form" >
                                    @csrf

                                    <div class="mb-3">
                                        <input name="email" value="{{old('email')}}" type="text" class="form-control" placeholder="Email Or Teacher Number" aria-label="Email" aria-describedby="email-addon">
                                    </div>
                            ...
                            <div class="card-footer text-center pt-0 px-lg-2 px-1">
                                <p class="mb-4 text-sm mx-auto">
                                    ...
                                    <a href="{{route('show.sign-up.page')}}" class="text-info text-gradient font-weight-bold">Sign up</a>
                                </p>
                            </div>
                        </div>
                    </div>
